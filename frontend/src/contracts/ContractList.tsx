      ...
      {contracts.map((contract) => (
        <div key={contract.id} className={styles.card}>
          <div className={styles.header}>
            <div className={styles.employeeName}>{contract.employee_name}</div>
            <button className={styles.editButton} onClick={() => onEdit(contract)}>
              編集
            </button>
          </div>
